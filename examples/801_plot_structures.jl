...
# ============================================================================
function plot_unit_cell_shapes(
    lat, bg_eps, inclusions, title_str; xlim=(-0.6, 1.6), ylim=(-0.6, 1.6)
)
    a1 = lat.vectors[1]
    a2 = lat.vectors[2]
...
p1 = plot_unit_cell_shapes(
    lat_tri, 1.0, inclusions_tri_rods, "Triangular Rods\n(ε=12, r=0.2a)"
)
...
pos1 = (1/6) * a1 + (1/6) * a2
pos2 = (-1/6) * a1 + (-1/6) * a2
inclusions_honey = [(collect(pos1), 0.14, 12.0), (collect(pos2), 0.14, 12.0)]
p3 = plot_unit_cell_shapes(
    lat_hex, 1.0, inclusions_honey, "Honeycomb Rods\n(ε=12, r=0.14a)"
)
...
p4 = plot_unit_cell_shapes(
    lat_tri, 12.0, inclusions_tri_holes, "Triangular Holes\n(ε=12 bg, r=0.45a)"
)
